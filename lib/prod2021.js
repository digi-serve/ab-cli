...
var Command = new utils.Resource({
   command: "prod2021",
   params: "--prod2021",
   descriptionShort: "perform a new installation of the AB production 2021 docker stack.",
   descriptionLong: `
`
});
   ...
   inquirer
      .prompt([
         ...
         },
         {
            name: "port",
            type: "input",
            message: "What port do you want AppBuilder to listen on for web connections:",
            default: 80,
            when: (values) => {
