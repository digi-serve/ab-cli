   ...
   utils.filePatch(
      [
         ...
         },
         {
            ...
            tag: /test_ab/g,
            replace: `test_${Options.stack || "ab"}`,
            log: `    Docker Stack: cypress.ab_runtime.json => ${Options.stack || "ab"}`,
         },
         {
            file: path.join(process.cwd(), "/test/e2e/cypress.app.json"),
            tag: /test_ab/g,
            replace: `test_${Options.stack || "ab"}`,
            log: `    Docker Stack: cypress.app.json => ${Options.stack || "ab"}`,
         },
         {
            file: path.join(process.cwd(), "/test/e2e/cypress.json"),
            tag: /test_ab/g,
            replace: `test_${Options.stack || "ab"}`,
            log: `    Docker Stack: cypress.json => ${Options.stack || "ab"}`,
         },
         {
            file: path.join(process.cwd(), "/test/e2e/cypress.plugin.ab_designer.json"),
            tag: /test_ab/g,
            replace: `test_${Options.stack || "ab"}`,
            log: `    Docker Stack: cypress.plugin.ab_designer.json => ${Options.stack || "ab"}`,
         },
         {
            file: path.join(
               process.cwd(),
