...
Command.help = function () {
  ...
  [options] :
    --verbose : display more console logs
...
function patchDockerStack(done) {
   const logOpts = { verbose: Options.verbose, color: "dim" };
   // Docker Stack update:
   utils.filePatch(
      [
         // patch our npm commands to reference our Docker Stack
         {
            ...
            log: utils.logFormatter.format(
               `Docker Stack: package.json => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            log: utils.logFormatter.format(
               `Docker Stack: package.json => test_${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            log: utils.logFormatter.format(
               `Docker Stack: logs.js => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            tag: / ab/g,
            log: utils.logFormatter.format(
               `Docker Stack: dockerImageUpate.js => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            replace: ` ${Options.stack || "ab"}`,
            log: utils.logFormatter.format(
               `Docker Stack: Down.sh => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
         ...
         },
         {
            ...
            replace: ` ${Options.stack || "ab"}`,
            log: utils.logFormatter.format(
               `Docker Stack: UP.sh => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            replace: ` ${Options.stack || "ab"}`,
            log: utils.logFormatter.format(
               `Docker Stack: configReset.sh => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            log: utils.logFormatter.format(
               `Docker Stack: testReset.sh => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            file: path.join(process.cwd(), "/test/e2e/cypress.json"),
            tag: /test_ab/g,
            replace: `test_${Options.stack || "ab"}`,
            log: utils.logFormatter.format(
               `Docker Stack: cypress.json => ${Options.stack || "ab"}`,
               logOpts
            ),
         },
         {
            ...
            replace: `"${Options.stack || "ab"}"`,
            log: utils.logFormatter.format(
               `Docker Stack: ${Options.stack}_system_monitor.js => ${
                  Options.stack || "ab"
               }`,
               logOpts
            ),
      ...
      utils.filePatch(
         [
            ...
            // patch our UP.sh to run developer start.
            {
               ...
               log: utils.logFormatter.format("UP.sh => develop", logOpts),
            },
         ],
         done
      );
