...
var Command = new utils.Resource({
    command: "ssl",
    params:
        "--self ||  --pathKey [pathToKey] --pathCert [pathToCert] || --none",
            ...
            .prompt([
                ...
                },
                {
                    ...
                    when: (values) => {
                        ...
                        return (
                            values.process == "self" && !options.sslCountryName
                        );
                    }
                },
                {
                    ...
                    when: (values) => {
                        // only display this question if we answered 'self' to 1st prompt
                        return (
                            values.process == "self" && !options.sslProvinceName
                        );
                    }
                },
                {
                    ...
                    when: (values) => {
                        // only display this question if we answered 'self' to 1st prompt
                        return (
                            values.process == "self" && !options.sslLocalityName
                        );
                    }
                },
                {
                ...
                },
                {
                    ...
                    when: (values) => {
                        // only display this question if we answered 'self' to 1st prompt
                        return (
                            values.process == "self" && !options.sslCommonName
                        );
                    }
                },
                {
                    ...
                    when: (values) => {
                        // only display this question if we answered 'self' to 1st prompt
                        return (
                            values.process == "self" && !options.sslEmailAddress
                        );
                    }
                },
                {
                    ...
                    when: (values) => {
                        // only display this question if we answered 'self' to 1st prompt
                        return (
                            values.process == "self" && !options.sslChallengePW
                        );
                    },
                    validate: (value) => {
