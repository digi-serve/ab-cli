...
const ${Options.action}Handler = require(path.join(__dirname, "src", "${
        Options.action
    }.js"));
        ...
        .prompt([
            {
                ...
                when: (values) => {
                    return (
                        !values.service && typeof Options.service == "undefined"
                    );
                }
            },
            {
                ...
                when: (values) => {
                    return (
                        !values.action && typeof Options.action == "undefined"
                    );
                }
            },
            {
            ...
            },
            {
                ...
                default: (values) => {
                    return `${values.service ||
                        Options.service}.${values.action || Options.action}`;
                },
                when: (values) => {
