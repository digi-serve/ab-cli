...
`;
  ...
  nginx_etc:`;
   ...
   var configComposeBindings = `target: /app/mysql/secret/password
      - type: bind
        source: ./nginx/nginx.conf
        target: /app/nginx/nginx.conf
      - type: bind
        source: ./nginx/default-nossl.conf
        target: /app/nginx/conf.d/default.conf
      - type: bind
        source: ./nginx/ssl
        target: /app/ssl`;
   ...
   var patches = [
      ...
      {
         file: path.join(process.cwd(), "config-compose.yml"),
         tag: "target: /app/mysql/secret/password",
