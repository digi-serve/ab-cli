   ...
   var patches = [
      {
         ...
         log: utils.logFormatter.format(
            "patching: 02-tenant_manager.sql connect URL to Tenant(Admin)",
            logOpts
         ),
      },
      {
         ...
         log: utils.logFormatter.format(
            "patching: 03-site_tables.sql with Tenant Admin Settings",
            logOpts
         ),
      },
      {
         ...
         log: utils.logFormatter.format(
            "patching: 03-site_tables.sql connect Role(System Admin) to User(Admin)",
            logOpts
         ),
      },
   ];
   ...
   const patches = [
      {
         ...
         log: utils.logFormatter.format(
            "patching: ./test/setup/config.js with Tenant Admin Settings (email)",
            logOpts
         ),
      },
      {
