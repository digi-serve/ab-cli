...
Countly.init = function(serverUrl, appKey) {
    ...
    cordova.exec(Countly.onSuccess, Countly.onError, "CountlyCordova", "init", [
        serverUrl,
        appKey
    ]);
};
...
Countly.sendEvent = function(options) {
    ...
    if (options.eventCount) args.push(options.eventCount.toString());
    if (options.eventSum) args.push(options.eventSum.toString());
